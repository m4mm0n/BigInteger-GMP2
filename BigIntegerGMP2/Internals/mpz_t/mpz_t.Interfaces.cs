    ...
    public partial class mpz_t : IDisposable, IEquatable<mpz_t>, ICloneable, IConvertible, IComparable, IComparable<mpz_t>
    {
        ...
        public bool Equals(mpz_t? other) =>
            ReferenceEquals(other, null)
                ...
                : mpz.cmp(this, other) == 0;

        /// <summary>
        /// Determines whether the specified object is equal to the current object.
        /// </summary>
        /// <param name="other">The object to compare with the current object.</param>
        bool IEquatable<mpz_t>.Equals(mpz_t? other) => Equals(other);
        ...
        /// </summary>
        public object Clone() => new mpz_t(this);
        ...
        public int CompareTo(object? obj) => obj is mpz_t other ? CompareTo(other) : throw new ArgumentException();
